...
int main(int argc, char** argv)
{
    ...
    while (ros::ok()) {
        ...
        ROS_INFO_STREAM(q);
        switch (q){
            case 1:         spawn_model_req.model_xml = red_xmlStr;
break;
            case 2:        spawn_model_req.model_xml = blue_xmlStr;
break;
            case 3:        spawn_model_req.model_xml = green_xmlStr;
break;
        }
        ...
        ros::spinOnce();
        ros::Duration(3.0).sleep(); // frequency control, spawn one cylinder in each loop
